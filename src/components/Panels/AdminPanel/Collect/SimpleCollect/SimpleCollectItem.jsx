                ...
                <>
                    ...
                    <Group header={<Header mode="secondary">Участники</Header>}>
                        {(props.collect.selected.Members && props.collect.selected.Members.length > 0) ?
                            <FormItem>
                                <List>
                                    {props.collect.selected.Members.map((item) => <InfoRow>{item.UserProfile.Name} {item.UserProfile.Surname} {item.UserProfileId == props.myProfile.UserProfileId && " (Организатор)"}</InfoRow>)}
                                </List>
                            </FormItem>
                            :
                            <FormItem>
